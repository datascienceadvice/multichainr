...
- tx:
  ...
  Optional character string. Hex representation or transaction ID of a
  transaction to test against. If omitted, a generic test is performed.

## Value

The result of the filter evaluation (typically a boolean or transformed
transaction).
