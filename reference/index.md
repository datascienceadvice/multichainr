...
- [`hex_to_char()`](https://datascienceadvice.github.io/multichainr/reference/hex_to_char.md)
...
- [`mc_help()`](https://datascienceadvice.github.io/multichainr/reference/mc_help.md)
...
- [`mc_wait_for_confirmation()`](https://datascienceadvice.github.io/multichainr/reference/mc_wait_for_confirmation.md)
  : Wait for transaction confirmation
- [`` `%||%` ``](https://datascienceadvice.github.io/multichainr/reference/null_default.md)
